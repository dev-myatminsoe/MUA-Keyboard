...
public class MyConfig {
	...
	private static boolean doubleTapFun;
	...
	public static boolean isDoubleTapFun() {
		return doubleTapFun;
	}

	public static void setDoubleTapFun(boolean doubleTapFun) {
		MyConfig.doubleTapFun = doubleTapFun;
	}
